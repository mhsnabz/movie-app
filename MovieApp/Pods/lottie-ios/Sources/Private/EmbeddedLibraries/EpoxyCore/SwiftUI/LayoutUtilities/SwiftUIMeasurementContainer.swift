...
private extension ViewType {
    ...
    @nonobjc
    func systemLayoutFittingIntrinsicSize() -> CGSize {
        #if os(macOS)
    ...
    @nonobjc
    func systemLayoutFittingIntrinsicHeightFixedWidth(
        _ width: CGFloat,
    ...
    @nonobjc
    func systemLayoutFittingIntrinsicWidthFixedHeight(
        _ height: CGFloat,
        priority: LayoutPriorityType = .almostRequired
    )
        -> CGSize
    ...
    @nonobjc
    func containsDoubleLayoutPassSubviews() -> Bool {
        #if os(macOS)
            return false
        #else
            var contains = false
...
private extension CGSize {
    ...
    func replacingNoIntrinsicMetric(with fallback: CGSize) -> CGSize {
        .init(
