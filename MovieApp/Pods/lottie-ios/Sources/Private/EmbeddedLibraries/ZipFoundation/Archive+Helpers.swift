...
extension Archive {
    ...
    func writeUncompressed(
        ...
        while position < size {
            ...
            try sizeWritten += Int64(Data.write(chunk: entryChunk, to: archiveFile))
    ...
    func writeCompressed(
        ...
        var sizeWritten: Int64 = 0
        let consumer: Consumer = { data in try sizeWritten += Int64(Data.write(chunk: data, to: self.archiveFile)) }
